...
def main(program, args):
    ...
    parser = argparse.ArgumentParser(prog=program, description="Run DNS fingerprint creation code.")
    parser.add_argument(
        "--dnsdata",
        type=str,
    ...
    ip_entropy_dict, ip_fingerprint = get_dns_fingerprint_info(ns.dnsdata)
