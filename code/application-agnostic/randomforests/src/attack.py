...
def run(dataset_npy):
    ...
    score, features_and_percentages, y_test_all, y_pred_all = rf_folds(X, y_i, feature_names, rfe_nfeatures=cst.KF_RFE_NFEATURES_TO_SELECT, rfe_steps=cst.KF_RFE_STEPS, n_trees=cst.N_TREES, n_classes=150)
