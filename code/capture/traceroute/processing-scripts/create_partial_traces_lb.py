...
def process(ASN=15169, opposite=False):
    ...
    TRACEROUTE_DIR = "../traceroutehar/outputquic100/" #Traceroute directory
    HAR_DIR = "../outputhar_lb_quic-100p-338/all/" #HAR file directory

    PCAP_DIR = "/home/jwhite/d/git/quic-fingerprinting/cf-clusters-datasets/quic-100p-150/pcaps" #Input pcaps
    OUTPUT_DIR = f"/home/jwhite/d/git/quic-fingerprinting/cf-clusters-datasets/quic-100p-150-{ASN}-view/pcaps" #Output directory for processed pcaps

    if opposite:
        OUTPUT_DIR = f"/run/media/jwhite/LB-DATASETS-2/quic-fingerprinting/cf-cluster-datasets/quic-80p-122-{ASN}-view-inverse/pcaps"
